...
const nav: Group[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { to: "/delivery/movements", label: "Internal Stock Movements", icon: ArrowLeftRight },
      { to: "/delivery/drivers", label: "Driver Assignments", icon: UserRound },
      { to: "/delivery/vehicles", label: "Vehicles", icon: Truck },
      { to: "/delivery/routes", label: "Delivery Coverage & Routes", icon: Building2 },
      { to: "/delivery/charges", label: "Delivery Charges", icon: Receipt },
