                  ...
                  <DropdownMenu>
                    ...
                    <DropdownMenuContent align="end" className="w-56">
                      ...
                      <DropdownMenuItem onSelect={() => setPriceEditingSku(l.sku)}>
                        ...
                        {l.manualUnitPrice != null ? "Edit price override" : "Override this item's price"}
                      </DropdownMenuItem>
                      <DropdownMenuItem onSelect={() => toggleDelivery(l.sku)}>
                        <Truck className="h-4 w-4" />
                        {l.requiresDelivery ? "Switch to counter pickup" : "Deliver this item instead of counter pickup"}
                      </DropdownMenuItem>
                      <DropdownMenuItem onSelect={() => removeLine(l.sku)} className="text-critical focus:text-critical">
