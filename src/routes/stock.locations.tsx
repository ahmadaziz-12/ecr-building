  ...
  head: () => ({
    meta: [
      { title: "Stock Locations — BuildPOS" },
      {
        name: "description",
        content:
          "Manage stock locations, zones, aisles, racks and bins across branches in BuildPOS.",
      },
      { property: "og:title", content: "Stock Locations — BuildPOS" },
      {
        property: "og:description",
        content: "Location hierarchy and stock eligibility for every branch balance.",
      },
