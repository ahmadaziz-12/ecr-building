...
// INPUT/TEXTAREA/SELECT/OPTION are deliberately NOT here: inputs/textareas have no
// text-node children (so nothing "inside" them is ever walked), but excluding them
// from shouldSkip lets their own placeholder/title/aria-label attributes translate;
// select/option option labels are static UI copy like any other text node.
