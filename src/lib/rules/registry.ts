...
export const TRIGGER_EVENTS: TriggerEvent[] = [
  ...
  ...["Custom Rate Calculated", "Custom Rate Submitted", "Custom Quotation Created", "Custom Quotation Accepted", "Supplier Rate Received"].map((l) => ev("Custom Pricing Events", l, ["Custom Pricing", "Sales", "Product", "Customer", "Purchase Order"])),
