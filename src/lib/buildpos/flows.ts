      ...
      },
      {
        ...
        fields: [
          ...
          },
          {
            ...
            type: "toggle",
            hint: "The POS reads live weight from a paired scale instead of manual/cut-to-size entry — mutually exclusive with Cut-to-size above.",
          },
          {
            name: "requiresSerialTracking",
            label: "Requires Serial Tracking",
            type: "toggle",
            hint: "Checkout requires scanning/entering one registered serial number per unit sold (power tools, generators, warranty items) — see Stock → Serial Number Tracking.",
          },
