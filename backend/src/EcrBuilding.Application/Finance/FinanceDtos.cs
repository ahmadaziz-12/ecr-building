...
public record ExpenseDto(int Id, string ExpenseNo, DateTime Date, int BranchId, string BranchName, string Category, string Description, string? Vendor, decimal Amount, decimal Vat, string Method, string Status);
...
public record ApproveReturnRequest(int WarehouseId);
